<footer id="site-footer" class="bg-gray-50">
  ...
  <div class="flex flex-col gap-16">
    ...
    <div class="flex flex-row justify-between items-center gap-4 pt-8 border-t border-gray-200">
      <p class="text-xs uppercase tracking-wide text-gray-400">© 2024 eVolume · All Rights Reserved.</p>
      <a
        href="https://unc.mn"
        target="_blank"
        class="group flex items-center gap-2 text-gray-400 transition duration-300 hover:text-gray-600"
      >
        <span class="hidden md:block text-sm max-w-0 overflow-hidden whitespace-nowrap opacity-0 group-hover:max-w-[200px] group-hover:opacity-100 transition-all duration-300">In partnership with Uncommon</span>
